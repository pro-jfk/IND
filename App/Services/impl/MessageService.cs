...
public class MessageService : IMessageService
{
    ...
    private readonly string _apiToken = "DP3q8j-VP9Ro1DLvaortjsniheOE4bIcOXCO1rk6xJg";
    ...
    public async Task<MessageResponse> UpdateMessageReceived(int customerId, int messageId, DateTime dateReceived,
        bool statusReceived)
    {
    ...
    public async void PrintMessage()
    {
        ...
        var values = new Dictionary<string, string>
        {
            ...
            {
                "content",
                "https://cdn.discordapp.com/attachments/1023870407155134468/1068479233233539132/Voorbeeld_bon.pdf"
            },
